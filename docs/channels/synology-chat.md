---
summary: "Synology Chat webhook setup and OctenClaw config"
read_when:
  - Setting up Synology Chat with OctenClaw
...
```bash
octenclaw plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your OctenClaw gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in OctenClaw.
...
- Pairing approvals work with:
  - `octenclaw pairing list synology-chat`
  - `octenclaw pairing approve synology-chat <CODE>`
...
```bash
octenclaw message send --channel synology-chat --target 123456 --text "Hello from OctenClaw"
octenclaw message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
