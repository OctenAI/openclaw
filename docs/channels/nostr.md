...
read_when:
  - You want OctenClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables OctenClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`octenclaw onboard`) and `octenclaw channels add` list optional channel plugins.
...
```bash
octenclaw plugins install @openclaw/nostr
```

Use a local checkout (dev workflows):

```bash
octenclaw plugins install --link <path-to-octenclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "octenclaw",
        "displayName": "OctenClaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "octenclaw@example.com",
        "lud16": "octenclaw@example.com"
      }
    }
  }
}
