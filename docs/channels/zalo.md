...
- Install via CLI: `octenclaw plugins install @openclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `octenclaw plugins install ./extensions/zalo`
   - From npm (if published): `octenclaw plugins install @openclaw/zalo`
...
- Approve via:
  - `octenclaw pairing list zalo`
  - `octenclaw pairing approve zalo <CODE>`
...
- Example: `octenclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `octenclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `octenclaw logs --follow`
