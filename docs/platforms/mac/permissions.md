...
- Same path: run the app from a fixed location (for OctenClaw, `dist/OpenClaw.app`).
...
Workaround: move files into the OctenClaw workspace (`~/.openclaw/workspace`) if you want to avoid per-folder grants.
