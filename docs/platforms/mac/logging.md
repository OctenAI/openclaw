---
summary: "OctenClaw logging: rolling diagnostics file log + unified log privacy flags"
read_when:
...
OctenClaw routes macOS app logs through swift-log (unified logging by default) and can write a local, rotating file log to disk when you need a durable capture.
...
## Enable for OctenClaw (`ai.openclaw`)
