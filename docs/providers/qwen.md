---
summary: "Use Qwen OAuth (free tier) in OctenClaw"
read_when:
  - You want to use Qwen with OctenClaw
...
```bash
octenclaw models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, OctenClaw will sync credentials
