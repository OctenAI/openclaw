---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OctenClaw"
read_when:
  - You want Xiaomi MiMo models in OctenClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OctenClaw uses
...
```bash
octenclaw onboard --auth-choice xiaomi-api-key
# or non-interactive
octenclaw onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
