...
You can point OctenClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OctenClaw
...
- [Anthropic provider](/providers/anthropic) - Native OctenClaw integration with Claude setup-token or API keys
