---
summary: "Use NVIDIA's OpenAI-compatible API in OctenClaw"
read_when:
  - You want to use NVIDIA models in OctenClaw
...
octenclaw onboard --auth-choice skip
octenclaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
