---
summary: "Use Qianfan's unified API to access many models in OctenClaw"
read_when:
...
3. OctenClaw installed on your system
...
4. Copy the API key for use with OctenClaw

## CLI setup

```bash
octenclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [OctenClaw Configuration](/gateway/configuration)
