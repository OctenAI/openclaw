---
summary: "Overview of OctenClaw onboarding options and flows"
read_when:
...
OctenClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`octenclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the OctenClaw app when you want a fully guided setup on macOS. Docs:
