---
summary: "First-run onboarding flow for OctenClaw (macOS app)"
read_when:
...
- By default, OctenClaw is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give OctenClaw">
...
<Step title="CLI">
  ...
  The app can install the global `octenclaw` CLI via npm/pnpm so terminal
