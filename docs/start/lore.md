---
summary: "Backstory and lore of OctenClaw for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "OctenClaw Lore"
---

# The Lore of OctenClaw 🦞📖
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **OctenClaw**.
...
In the end, **OctenClaw** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
The **Moltiverse** is the community and ecosystem around OctenClaw. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then OctenClaw): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "octenclaw what did we discuss about talking with people xD"
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at OctenClaw" to promote pump-and-dump tokens.
...
**The Great OctenClaw Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/openclaw/openclaw` ✅
- X handle `@octenclaw` secured with GOLD CHECKMARK 💰
