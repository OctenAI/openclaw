# Contributing to the OctenClaw Threat Model

Thanks for helping make OctenClaw more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.
...
- Which parts of OctenClaw are affected (CLI, gateway, channels, ClawHub, MCP servers, etc.)
...
- [OctenClaw Threat Model](/security/THREAT-MODEL-ATLAS)
...
Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the OctenClaw security hall of fame for significant contributions.
