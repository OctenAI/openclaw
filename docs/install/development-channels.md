...
OctenClaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, OctenClaw also aligns
the install method:
...
When you switch channels with `octenclaw update`, OctenClaw also syncs plugin sources:
