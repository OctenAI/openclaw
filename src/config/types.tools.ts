...
export type ToolsConfig = {
  ...
  web?: {
    search?: {
      ...
      enabled?: boolean;
      /** Search provider ("brave", "firecrawl", "gemini", "grok", "kimi", "perplexity", or "octen"). */
      provider?: "brave" | "firecrawl" | "gemini" | "grok" | "kimi" | "perplexity" | "octen";
      ...
      /** Octen-specific configuration (used when provider="octen"). */
      octen?: {
        /** Octen API key (defaults to OCTEN_API_KEY env var). */
        apiKey?: SecretInput;
        /** Base URL for API requests (defaults to "https://api.octen.ai"). */
        baseUrl?: string;
      };
    };
    fetch?: {
