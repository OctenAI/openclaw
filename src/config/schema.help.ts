...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.enabled": "Enable the web_search tool (requires an Octen API key).",
  "tools.web.search.provider": 'Search provider. Only "octen" is supported.',
  "tools.web.search.maxResults": "Number of results to return (1-10).",
  "tools.web.search.timeoutSeconds": "Timeout in seconds for web_search requests.",
  "tools.web.search.cacheTtlMinutes": "Cache TTL in minutes for web_search results.",
  "tools.web.search.octen.apiKey":
    "Octen API key (fallback: OCTEN_API_KEY env var).",
  "tools.web.search.octen.baseUrl":
    'Octen API base URL override (default: "https://api.octen.ai").',
